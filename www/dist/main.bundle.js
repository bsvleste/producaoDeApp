...
var AppComponent = (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.authService.mostraMenuEmmiter.subscribe(function (mostrar) { return _this.mostrarMenu = mostrar; });
    };
    return AppComponent;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__login_auth_service__ = __webpack_require__("../../../../../src/app/login/auth.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__guard_auth_guard__ = __webpack_require__("../../../../../src/app/guard/auth-guard.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__guard_cursos_guard__ = __webpack_require__("../../../../../src/app/guard/cursos-guard.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__guard_alunos_guard__ = __webpack_require__("../../../../../src/app/guard/alunos-guard.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["M" /* NgModule */])({
        ...
        providers: [
            __WEBPACK_IMPORTED_MODULE_8__login_auth_service__["a" /* AuthService */],
            __WEBPACK_IMPORTED_MODULE_9__guard_auth_guard__["a" /* AuthGuard */],
            __WEBPACK_IMPORTED_MODULE_10__guard_cursos_guard__["a" /* CursoGuard */],
            __WEBPACK_IMPORTED_MODULE_11__guard_alunos_guard__["a" /* AlunosGuard */]
        ],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__guard_cursos_guard__ = __webpack_require__("../../../../../src/app/guard/cursos-guard.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__guard_alunos_guard__ = __webpack_require__("../../../../../src/app/guard/alunos-guard.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var appRoutes = [
    { path: 'cursos',
        ...
        canActivateChild: [__WEBPACK_IMPORTED_MODULE_5__guard_cursos_guard__["a" /* CursoGuard */]],
        canLoad: [__WEBPACK_IMPORTED_MODULE_4__guard_auth_guard__["a" /* AuthGuard */]]
    },
    { path: 'alunos',
        loadChildren: 'app/alunos/alunos.module#AlunosModule',
        canActivate: [__WEBPACK_IMPORTED_MODULE_4__guard_auth_guard__["a" /* AuthGuard */]],
        canActivateChild: [__WEBPACK_IMPORTED_MODULE_6__guard_alunos_guard__["a" /* AlunosGuard */]],
        canLoad: [__WEBPACK_IMPORTED_MODULE_4__guard_auth_guard__["a" /* AuthGuard */]]
    },
    { path: '', component: __WEBPACK_IMPORTED_MODULE_3__home_home_component__["a" /* HomeComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_4__guard_auth_guard__["a" /* AuthGuard */]] },
    { path: 'home', component: __WEBPACK_IMPORTED_MODULE_3__home_home_component__["a" /* HomeComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_4__guard_auth_guard__["a" /* AuthGuard */]] },
...
var AlunosGuard = (function () {
    function AlunosGuard(authService) {
        this.authService = authService;
    }
...
var AuthGuard = (function () {
    ...
    AuthGuard.prototype.verificaAcesso = function () {
        if (this.authService.usuarioLogado()) {
            return true;
        }
        this.router.navigate(['/login']);
...
/***/ "../../../../../src/app/guard/cursos-guard.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CursoGuard; });
var CursoGuard = (function () {
    function CursoGuard() {
    }
    CursoGuard.prototype.canActivateChild = function (route, state) {
...
var AuthService = (function () {
    function AuthService(router) {
        ...
        this.adm = false;
        this.mostraMenuEmmiter = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["x" /* EventEmitter */]();
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__usuario__ = __webpack_require__("../../../../../src/app/login/usuario.ts");
